...
class FollowRelationSerializer(serializers.ModelSerializer):
    followername = serializers.ReadOnlyField(source='followerid.username')
    followedname = serializers.ReadOnlyField(source='followedid.username') 
    class Meta:
...
class GroupSerializer(serializers.ModelSerializer):
    groupownername = serializers.ReadOnlyField(source='groupownerid.username')
